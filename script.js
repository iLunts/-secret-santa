var data = [
  ...
  { id: '', type: 'quiz', color: '#f44336', text: '№ 1', src: 'img/nordic-1.jpg' },
  { id: '', type: 'quiz', color: '#b71c1c', text: '№ 2', src: 'img/nordic-2.jpg' },
  { id: '', type: 'quiz', color: '#f44336', text: '№ 3', src: 'img/gusto-3.jpg' },
  { id: '', type: 'quiz', color: '#b71c1c', text: '№ 4', src: 'img/nordic-4.jpg' },
  { id: '', type: 'quiz', color: '#f44336', text: '№ 5', src: 'img/nordic-5.jpg' },
  { id: '', type: 'quiz', color: '#b71c1c', text: '№ 6', src: 'img/nestle-6.jpg' },
  { id: '', type: 'quiz', color: '#f44336', text: '#7', src: 'img/gusto-7.jpg' },
  { id: '', type: 'quiz', color: '#b71c1c', text: '№ 1', src: 'img/nordic-1.jpg' },
  { id: '', type: 'quiz', color: '#f44336', text: '№ 2', src: 'img/nordic-2.jpg' },
  { id: '', type: 'quiz', color: '#b71c1c', text: '№ 3', src: 'img/gusto-3.jpg' },
  { id: '', type: 'quiz', color: '#f44336', text: '№ 4', src: 'img/nordic-4.jpg' },
  { id: '', type: 'quiz', color: '#b71c1c', text: '№ 5', src: 'img/nordic-5.jpg' },
  { id: '', type: 'quiz', color: '#f44336', text: '№ 6', src: 'img/nestle-6.jpg' },
  { id: '', type: 'quiz', color: '#b71c1c', text: '#7', src: 'img/gusto-7.jpg' },
];
...
$(window).ready(function(){
  ...
  spinner.on('spin:end', function(r){ 
    ...
    $(".result").attr("src", data[r._index].src);
  });
